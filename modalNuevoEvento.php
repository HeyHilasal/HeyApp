...
<div class="modal" id="exampleModal"  tabindex="-1" role="dialog">
  ...
  <input type="radio" name="color_evento" id="amber" value="#FFD700">  
  <label for="amber" class="circu" style="background-color: #FFD700;"> </label>

  <input type="radio" name="color_evento" id="lime" value="#98FF1E">  
  <label for="lime" class="circu" style="background-color: #98FF1E;"> </label>
